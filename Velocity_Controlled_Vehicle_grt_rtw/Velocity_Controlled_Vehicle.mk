###########################################################################
## Makefile generated for component 'Velocity_Controlled_Vehicle'. 
## 
## Makefile     : Velocity_Controlled_Vehicle.mk
## Generated on : Mon Apr 26 19:25:52 2021
## Modified on  : Tue June 28 11:51:32 2023 (Nils)
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/Velocity_Controlled_Vehicle
...
PRODUCT_NAME              = Velocity_Controlled_Vehicle
MAKEFILE                  = Velocity_Controlled_Vehicle.mk
...
DIVINE_PATH 			  = /home/nils/divine-4.4.2
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/Velocity_Controlled_Vehicle
PRODUCT-DIV = $(RELATIVE_PATH_TO_ANCHOR)/Velocity_Controlled_Vehicle.bc
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(START_DIR)/Velocity_Controlled_Vehicle_grt_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common
...
DEFINES_STANDARD = -DMODEL=Velocity_Controlled_Vehicle -DNUMST=2 -DNCSTATES=10 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
OBJS = rt_logging.o Velocity_Controlled_Vehicle.o Velocity_Controlled_Vehicle_data.o rtGetInf.o rtGetNaN.o rt_nonfinite.o
...
%.o : $(START_DIR)/Velocity_Controlled_Vehicle_grt_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/Velocity_Controlled_Vehicle_grt_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
Velocity_Controlled_Vehicle.o : $(START_DIR)/Velocity_Controlled_Vehicle_grt_rtw/Velocity_Controlled_Vehicle.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


Velocity_Controlled_Vehicle_data.o : $(START_DIR)/Velocity_Controlled_Vehicle_grt_rtw/Velocity_Controlled_Vehicle_data.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


rtGetInf.o : $(START_DIR)/Velocity_Controlled_Vehicle_grt_rtw/rtGetInf.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


rtGetNaN.o : $(START_DIR)/Velocity_Controlled_Vehicle_grt_rtw/rtGetNaN.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


rt_nonfinite.o : $(START_DIR)/Velocity_Controlled_Vehicle_grt_rtw/rt_nonfinite.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
